...
pub struct RegisterBlock {
    ...
    #[doc = "0x58 - XOSC Minimum Period Value inimum Value of STMPXPER"]
    ...
    #[doc = "0x70 - Interrupt Mask Register elects mask states of the flags in IRQFLAGS that contribute to the I2S_IRQ event."]
    pub irqmask: IRQMASK,
...
#[doc = "Interrupt Mask Register elects mask states of the flags in IRQFLAGS that contribute to the I2S_IRQ event.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [irqmask](irqmask) module"]
