...
pub struct RegisterBlock {
    #[doc = "0x00 - Control his register contains various bitfields for configuration of RTC TL Name = CONFIG"]
    pub ctl: CTL,
    #[doc = "0x04 - Event Flags, RTC Status his register contains event flags from the 3 RTC channels. Each flag will be cleared when writing a '1' to the corresponding bitfield."]
    pub evflags: EVFLAGS,
    #[doc = "0x08 - Second Counter Value, Integer Part"]
    pub sec: SEC,
    #[doc = "0x0c - Second Counter Value, Fractional Part"]
    pub subsec: SUBSEC,
    #[doc = "0x10 - Subseconds Increment alue added to SUBSEC.VALUE on every SCLK_LFclock cycle."]
    ...
    pub ch2cmp: CH2CMP,
    #[doc = "0x24 - Channel 2 Compare Value Auto-increment his register is primarily used to generate periodical wake-up for the AUX_SCE module, through the \\[AUX_EVCTL.EVSTAT0.AON_RTC\\]
event."]
    pub ch2cmpinc: CH2CMPINC,
    #[doc = "0x28 - Channel 1 Capture Value f CHCTL.CH1_EN = 1and CHCTL.CH1_CAPT_EN = 1, capture occurs on each rising edge of the event selected in AON_EVENT:RTCSEL."]
    pub ch1capt: CH1CAPT,
    #[doc = "0x2c - AON Synchronization his register is used for synchronizing between MCU and entire AON domain."]
    pub sync: SYNC,
    #[doc = "0x30 - Current Counter Value"]
    pub time: TIME,
    #[doc = "0x34 - Synchronization to SCLK_LF his register is used for synchronizing MCU to positive or negative edge of SCLK_LF."]
    pub synclf: SYNCLF,
}
#[doc = "Control his register contains various bitfields for configuration of RTC TL Name = CONFIG\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ctl](ctl) module"]
...
#[doc = "Control his register contains various bitfields for configuration of RTC TL Name = CONFIG"]
pub mod ctl;
#[doc = "Event Flags, RTC Status his register contains event flags from the 3 RTC channels. Each flag will be cleared when writing a '1' to the corresponding bitfield.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [evflags](evflags) module"]
...
#[doc = "Channel 2 Compare Value"]
pub mod ch2cmp;
#[doc = "Channel 2 Compare Value Auto-increment his register is primarily used to generate periodical wake-up for the AUX_SCE module, through the \\[AUX_EVCTL.EVSTAT0.AON_RTC\\]
...
event."]
pub mod ch2cmpinc;
#[doc = "Channel 1 Capture Value f CHCTL.CH1_EN = 1and CHCTL.CH1_CAPT_EN = 1, capture occurs on each rising edge of the event selected in AON_EVENT:RTCSEL.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch1capt](ch1capt) module"]
...
#[doc = "Channel 1 Capture Value f CHCTL.CH1_EN = 1and CHCTL.CH1_CAPT_EN = 1, capture occurs on each rising edge of the event selected in AON_EVENT:RTCSEL."]
pub mod ch1capt;
#[doc = "AON Synchronization his register is used for synchronizing between MCU and entire AON domain.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sync](sync) module"]
...
#[doc = "Current Counter Value"]
pub mod time;
#[doc = "Synchronization to SCLK_LF his register is used for synchronizing MCU to positive or negative edge of SCLK_LF.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [synclf](synclf) module"]
pub type SYNCLF = crate::Reg<u32, _SYNCLF>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SYNCLF;
#[doc = "`read()` method returns [synclf::R](synclf::R) reader structure"]
impl crate::Readable for SYNCLF {}
#[doc = "Synchronization to SCLK_LF his register is used for synchronizing MCU to positive or negative edge of SCLK_LF."]
pub mod synclf;
