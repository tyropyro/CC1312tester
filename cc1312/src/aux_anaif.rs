...
pub struct RegisterBlock {
    ...
    #[doc = "0x10 - ADC Control onfiguration of ADI_4_AUX:ADC0.SMPL_MODE decides if the ADC trigger starts sampling or conversion."]
    pub adcctl: ADCCTL,
    #[doc = "0x14 - ADC FIFO Status IFO can hold up to four ADC samples."]
    ...
    #[doc = "0x30 - DAC Control his register controls the analog part of the DAC."]
    pub dacctl: DACCTL,
    #[doc = "0x34 - Low Power Mode Bias Control he low power mode bias module provides bias current to DAC and Comparator A when AUX_SYSIF:OPMODEREQ.REQ differers from A."]
    pub lpmbiasctl: LPMBIASCTL,
    #[doc = "0x38 - DAC Sample Control he DAC sample clock maintains the DAC voltage stored in the sample-and-hold capacitor. The DAC sample clock waveform consists of a setup phase followed by a hold phase. In the setup phase the sample-and-hold capacitor charges to the programmed voltage. The hold phase maintains the voltage with minimal power. ACSMPLCFG0 and DACSMPLCFG1 configure the DAC sample clock waveform."]
    pub dacsmplctl: DACSMPLCTL,
    #[doc = "0x3c - DAC Sample Configuration 0"]
    pub dacsmplcfg0: DACSMPLCFG0,
    #[doc = "0x40 - DAC Sample Configuration 1 he sample clock period equals (high time + low time) * base period. DACSMPLCFG0.CLKDIV determines the base period. iming requirements (DAC Buffer On / DAC Buffer Off): (high time + low time) * base period > (4 us / 1 us) (high time * base period) > (2 us / 0.5 us) (low time * base period) > (2 us / 0.5 us) (low time * base period + HOLD_INTERVAL * sample clock period) < 32 us f AUX_SYSIF:OPMODEREQ.REQ equals PDLP, you must set: H_PER = L_PER = HOLD_INTERVAL = 0."]
...
#[doc = "ADC Control onfiguration of ADI_4_AUX:ADC0.SMPL_MODE decides if the ADC trigger starts sampling or conversion.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [adcctl](adcctl) module"]
...
#[doc = "Current Source Control"]
pub mod isrcctl;
#[doc = "DAC Control his register controls the analog part of the DAC.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dacctl](dacctl) module"]
...
#[doc = "DAC Control his register controls the analog part of the DAC."]
pub mod dacctl;
#[doc = "Low Power Mode Bias Control he low power mode bias module provides bias current to DAC and Comparator A when AUX_SYSIF:OPMODEREQ.REQ differers from A.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lpmbiasctl](lpmbiasctl) module"]
