...
pub struct RegisterBlock {
    #[doc = "0x00 - Event Status 0 egister holds events 0 thru 15 of the 64-bit event bus that is synchronous to AUX clock. All events read through this register are synchronized at SCE clock rate, unless otherwise noted. The following subscribers use the asynchronous version of events in this register. AUX_TIMER2. AUX_ANAIF. AUX_TDC. AUX_SYSIF. AUX_AIODIOn. EVOBSCFG."]
    pub evstat0: EVSTAT0,
    #[doc = "0x04 - Event Status 1 egister holds events 16 thru 31 of the 64-bit event bus that is synchronous to AUX clock. All events read through this register are synchronized at SCE clock rate, unless otherwise noted. The following subscribers use the asynchronous version of events in this register. AUX_TIMER2. AUX_ANAIF. AUX_TDC. AUX_SYSIF. AUX_AIODIOn. EVOBSCFG."]
    pub evstat1: EVSTAT1,
    #[doc = "0x08 - Event Status 2 egister holds events 32 thru 47 of the 64-bit event bus that is synchronous to AUX clock. All events read through this register are synchronized at SCE clock rate, unless otherwise noted. The following subscribers use the asynchronous version of events in this register. AUX_TIMER2. AUX_ANAIF. AUX_TDC. AUX_SYSIF. AUX_AIODIOn. EVOBSCFG."]
    pub evstat2: EVSTAT2,
    #[doc = "0x0c - Event Status 3 egister holds events 48 thru 63 of the 64-bit event bus that is synchronous to AUX clock. All events read through this register are synchronized at SCE clock rate, unless otherwise noted. The following subscribers use the asynchronous version of events in this register. AUX_TIMER2. AUX_ANAIF. AUX_TDC . AUX_SYSIF. AUX_AIODIOn. EVOBSCFG."]
    pub evstat3: EVSTAT3,
    #[doc = "0x10 - Sensor Controller Engine Wait Event Configuration 0 onfiguration of this register and SCEWEVCFG1 controls bit index 7 in AUX_SCE:WUSTAT.EV_SIGNALS. This bit can be used by AUX_SCE WEV0, WEV1, BEV0 and BEV1 instructions. hen COMB_EV_EN = 0: UX_SCE:WUSTAT.EV_SIGNALS (7) = EV0_SEL event hen COMB_EV_EN = 1: UX_SCE:WUSTAT.EV_SIGNALS (7) = ( EV0_SEL event ) OR ( SCEWEVCFG1.EV1_SEL event ) it fields SCEWEVCFG1.EV0_POL and SCEWEVCFG1.EV1_POL control the polarity of selected events. vent combination is useful when there is a need to wait for a certain condition with timeout."]
    pub scewevcfg0: SCEWEVCFG0,
    #[doc = "0x14 - Sensor Controller Engine Wait Event Configuration 1 ee SCEWEVCFG0 for description."]
    pub scewevcfg1: SCEWEVCFG1,
    #[doc = "0x18 - Direct Memory Access Control"]
    pub dmactl: DMACTL,
    _reserved7: [u8; 4usize],
    #[doc = "0x20 - Software Event Set et software event flags from AUX domain to AON and MCU domains. CPUs in MCU domain can read the event flags from EVTOAONFLAGS and clear them in EVTOAONFLAGSCLR. se of these event flags is software-defined."]
    pub swevset: SWEVSET,
    #[doc = "0x24 - Events To AON Flags his register contains a collection of event flags routed to AON_EVENT. o clear an event flag, write to EVTOAONFLAGSCLR or write 0 to event flag in this register."]
    pub evtoaonflags: EVTOAONFLAGS,
    #[doc = "0x28 - Events To AON Polarity vent source polarity configuration for EVTOAONFLAGS."]
    pub evtoaonpol: EVTOAONPOL,
    #[doc = "0x2c - Events To AON Clear lear event flags in EVTOAONFLAGS. n order to clear a level sensitive event flag, the event must be deasserted."]
    pub evtoaonflagsclr: EVTOAONFLAGSCLR,
    #[doc = "0x30 - Events to MCU Flags his register contains a collection of event flags routed to MCU domain. o clear an event flag, write to EVTOMCUFLAGSCLR or write 0 to event flag in this register. Follow procedure described in AUX_SYSIF:WUCLR to clear AUX_WU_EV event flag."]
    pub evtomcuflags: EVTOMCUFLAGS,
    #[doc = "0x34 - Event To MCU Polarity vent source polarity configuration for EVTOMCUFLAGS."]
    pub evtomcupol: EVTOMCUPOL,
    #[doc = "0x38 - Events To MCU Flags Clear lear event flags in EVTOMCUFLAGS. n order to clear a level sensitive event flag, the event must be deasserted."]
    pub evtomcuflagsclr: EVTOMCUFLAGSCLR,
    #[doc = "0x3c - Combined Event To MCU Mask elect event flags in EVTOMCUFLAGS that contribute to the AUX_COMB event to EVENT and system CPU. he AUX_COMB event is high as long as one or more of the included event flags are set."]
    ...
    pub progdly: PROGDLY,
    #[doc = "0x48 - Manual rogrammable event."]
    pub manual: MANUAL,
...
#[doc = "Event Status 0 egister holds events 0 thru 15 of the 64-bit event bus that is synchronous to AUX clock. All events read through this register are synchronized at SCE clock rate, unless otherwise noted. The following subscribers use the asynchronous version of events in this register. AUX_TIMER2. AUX_ANAIF. AUX_TDC. AUX_SYSIF. AUX_AIODIOn. EVOBSCFG.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [evstat0](evstat0) module"]
...
#[doc = "Event Status 0 egister holds events 0 thru 15 of the 64-bit event bus that is synchronous to AUX clock. All events read through this register are synchronized at SCE clock rate, unless otherwise noted. The following subscribers use the asynchronous version of events in this register. AUX_TIMER2. AUX_ANAIF. AUX_TDC. AUX_SYSIF. AUX_AIODIOn. EVOBSCFG."]
pub mod evstat0;
#[doc = "Event Status 1 egister holds events 16 thru 31 of the 64-bit event bus that is synchronous to AUX clock. All events read through this register are synchronized at SCE clock rate, unless otherwise noted. The following subscribers use the asynchronous version of events in this register. AUX_TIMER2. AUX_ANAIF. AUX_TDC. AUX_SYSIF. AUX_AIODIOn. EVOBSCFG.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [evstat1](evstat1) module"]
...
#[doc = "Event Status 1 egister holds events 16 thru 31 of the 64-bit event bus that is synchronous to AUX clock. All events read through this register are synchronized at SCE clock rate, unless otherwise noted. The following subscribers use the asynchronous version of events in this register. AUX_TIMER2. AUX_ANAIF. AUX_TDC. AUX_SYSIF. AUX_AIODIOn. EVOBSCFG."]
pub mod evstat1;
#[doc = "Event Status 2 egister holds events 32 thru 47 of the 64-bit event bus that is synchronous to AUX clock. All events read through this register are synchronized at SCE clock rate, unless otherwise noted. The following subscribers use the asynchronous version of events in this register. AUX_TIMER2. AUX_ANAIF. AUX_TDC. AUX_SYSIF. AUX_AIODIOn. EVOBSCFG.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [evstat2](evstat2) module"]
...
#[doc = "Event Status 2 egister holds events 32 thru 47 of the 64-bit event bus that is synchronous to AUX clock. All events read through this register are synchronized at SCE clock rate, unless otherwise noted. The following subscribers use the asynchronous version of events in this register. AUX_TIMER2. AUX_ANAIF. AUX_TDC. AUX_SYSIF. AUX_AIODIOn. EVOBSCFG."]
pub mod evstat2;
#[doc = "Event Status 3 egister holds events 48 thru 63 of the 64-bit event bus that is synchronous to AUX clock. All events read through this register are synchronized at SCE clock rate, unless otherwise noted. The following subscribers use the asynchronous version of events in this register. AUX_TIMER2. AUX_ANAIF. AUX_TDC . AUX_SYSIF. AUX_AIODIOn. EVOBSCFG.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [evstat3](evstat3) module"]
...
#[doc = "Event Status 3 egister holds events 48 thru 63 of the 64-bit event bus that is synchronous to AUX clock. All events read through this register are synchronized at SCE clock rate, unless otherwise noted. The following subscribers use the asynchronous version of events in this register. AUX_TIMER2. AUX_ANAIF. AUX_TDC . AUX_SYSIF. AUX_AIODIOn. EVOBSCFG."]
pub mod evstat3;
#[doc = "Sensor Controller Engine Wait Event Configuration 0 onfiguration of this register and SCEWEVCFG1 controls bit index 7 in AUX_SCE:WUSTAT.EV_SIGNALS. This bit can be used by AUX_SCE WEV0, WEV1, BEV0 and BEV1 instructions. hen COMB_EV_EN = 0: UX_SCE:WUSTAT.EV_SIGNALS (7) = EV0_SEL event hen COMB_EV_EN = 1: UX_SCE:WUSTAT.EV_SIGNALS (7) = ( EV0_SEL event ) OR ( SCEWEVCFG1.EV1_SEL event ) it fields SCEWEVCFG1.EV0_POL and SCEWEVCFG1.EV1_POL control the polarity of selected events. vent combination is useful when there is a need to wait for a certain condition with timeout.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [scewevcfg0](scewevcfg0) module"]
...
#[doc = "Sensor Controller Engine Wait Event Configuration 0 onfiguration of this register and SCEWEVCFG1 controls bit index 7 in AUX_SCE:WUSTAT.EV_SIGNALS. This bit can be used by AUX_SCE WEV0, WEV1, BEV0 and BEV1 instructions. hen COMB_EV_EN = 0: UX_SCE:WUSTAT.EV_SIGNALS (7) = EV0_SEL event hen COMB_EV_EN = 1: UX_SCE:WUSTAT.EV_SIGNALS (7) = ( EV0_SEL event ) OR ( SCEWEVCFG1.EV1_SEL event ) it fields SCEWEVCFG1.EV0_POL and SCEWEVCFG1.EV1_POL control the polarity of selected events. vent combination is useful when there is a need to wait for a certain condition with timeout."]
pub mod scewevcfg0;
#[doc = "Sensor Controller Engine Wait Event Configuration 1 ee SCEWEVCFG0 for description.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [scewevcfg1](scewevcfg1) module"]
...
#[doc = "Direct Memory Access Control"]
pub mod dmactl;
#[doc = "Software Event Set et software event flags from AUX domain to AON and MCU domains. CPUs in MCU domain can read the event flags from EVTOAONFLAGS and clear them in EVTOAONFLAGSCLR. se of these event flags is software-defined.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [swevset](swevset) module"]
...
#[doc = "Software Event Set et software event flags from AUX domain to AON and MCU domains. CPUs in MCU domain can read the event flags from EVTOAONFLAGS and clear them in EVTOAONFLAGSCLR. se of these event flags is software-defined."]
pub mod swevset;
#[doc = "Events To AON Flags his register contains a collection of event flags routed to AON_EVENT. o clear an event flag, write to EVTOAONFLAGSCLR or write 0 to event flag in this register.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [evtoaonflags](evtoaonflags) module"]
...
#[doc = "Events To AON Polarity vent source polarity configuration for EVTOAONFLAGS.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [evtoaonpol](evtoaonpol) module"]
...
#[doc = "Events To AON Polarity vent source polarity configuration for EVTOAONFLAGS."]
pub mod evtoaonpol;
#[doc = "Events To AON Clear lear event flags in EVTOAONFLAGS. n order to clear a level sensitive event flag, the event must be deasserted.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [evtoaonflagsclr](evtoaonflagsclr) module"]
...
#[doc = "Events to MCU Flags his register contains a collection of event flags routed to MCU domain. o clear an event flag, write to EVTOMCUFLAGSCLR or write 0 to event flag in this register. Follow procedure described in AUX_SYSIF:WUCLR to clear AUX_WU_EV event flag.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [evtomcuflags](evtomcuflags) module"]
...
#[doc = "Event To MCU Polarity vent source polarity configuration for EVTOMCUFLAGS.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [evtomcupol](evtomcupol) module"]
...
#[doc = "Event To MCU Polarity vent source polarity configuration for EVTOMCUFLAGS."]
pub mod evtomcupol;
#[doc = "Events To MCU Flags Clear lear event flags in EVTOMCUFLAGS. n order to clear a level sensitive event flag, the event must be deasserted.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [evtomcuflagsclr](evtomcuflagsclr) module"]
...
#[doc = "Combined Event To MCU Mask elect event flags in EVTOMCUFLAGS that contribute to the AUX_COMB event to EVENT and system CPU. he AUX_COMB event is high as long as one or more of the included event flags are set.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [combevtomcumask](combevtomcumask) module"]
