#[doc = "Reader of register COMP5"]
pub type R = crate::R<u32, super::COMP5>;
#[doc = "Writer for register COMP5"]
pub type W = crate::W<u32, super::COMP5>;
#[doc = "Register COMP5 `reset()`'s with value 0"]
impl crate::ResetValue for super::COMP5 {
    type Type = u32;
    #[inline(always)]
