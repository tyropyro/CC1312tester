#[doc = "Reader of register COMP4"]
pub type R = crate::R<u32, super::COMP4>;
#[doc = "Writer for register COMP4"]
pub type W = crate::W<u32, super::COMP4>;
#[doc = "Register COMP4 `reset()`'s with value 0"]
impl crate::ResetValue for super::COMP4 {
    type Type = u32;
    #[inline(always)]
