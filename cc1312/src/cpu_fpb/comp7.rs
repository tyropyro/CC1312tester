#[doc = "Reader of register COMP7"]
pub type R = crate::R<u32, super::COMP7>;
#[doc = "Writer for register COMP7"]
pub type W = crate::W<u32, super::COMP7>;
#[doc = "Register COMP7 `reset()`'s with value 0"]
impl crate::ResetValue for super::COMP7 {
    type Type = u32;
    #[inline(always)]
