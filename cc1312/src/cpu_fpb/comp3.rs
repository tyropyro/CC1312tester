#[doc = "Reader of register COMP3"]
pub type R = crate::R<u32, super::COMP3>;
#[doc = "Writer for register COMP3"]
pub type W = crate::W<u32, super::COMP3>;
#[doc = "Register COMP3 `reset()`'s with value 0"]
impl crate::ResetValue for super::COMP3 {
    type Type = u32;
    #[inline(always)]
