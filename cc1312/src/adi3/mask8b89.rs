#[doc = "Writer for register MASK8B89"]
pub type W = crate::W<u32, super::MASK8B89>;
#[doc = "Register MASK8B89 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B89 {
    type Type = u32;
    #[inline(always)]
