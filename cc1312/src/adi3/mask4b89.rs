#[doc = "Writer for register MASK4B89"]
pub type W = crate::W<u32, super::MASK4B89>;
#[doc = "Register MASK4B89 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B89 {
    type Type = u32;
    #[inline(always)]
