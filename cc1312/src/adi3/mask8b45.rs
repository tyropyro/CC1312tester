#[doc = "Writer for register MASK8B45"]
pub type W = crate::W<u32, super::MASK8B45>;
#[doc = "Register MASK8B45 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B45 {
    type Type = u32;
    #[inline(always)]
