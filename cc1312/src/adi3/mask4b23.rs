#[doc = "Writer for register MASK4B23"]
pub type W = crate::W<u32, super::MASK4B23>;
#[doc = "Register MASK4B23 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B23 {
    type Type = u32;
    #[inline(always)]
