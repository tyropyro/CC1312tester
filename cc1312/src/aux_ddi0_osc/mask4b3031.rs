#[doc = "Writer for register MASK4B3031"]
pub type W = crate::W<u32, super::MASK4B3031>;
#[doc = "Register MASK4B3031 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B3031 {
    type Type = u32;
    #[inline(always)]
