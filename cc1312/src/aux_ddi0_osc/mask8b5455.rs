#[doc = "Writer for register MASK8B5455"]
pub type W = crate::W<u32, super::MASK8B5455>;
#[doc = "Register MASK8B5455 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B5455 {
    type Type = u32;
    #[inline(always)]
