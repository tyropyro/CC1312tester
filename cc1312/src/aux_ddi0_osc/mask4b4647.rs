#[doc = "Writer for register MASK4B4647"]
pub type W = crate::W<u32, super::MASK4B4647>;
#[doc = "Register MASK4B4647 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B4647 {
    type Type = u32;
    #[inline(always)]
