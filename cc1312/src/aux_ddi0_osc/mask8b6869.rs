#[doc = "Writer for register MASK8B6869"]
pub type W = crate::W<u32, super::MASK8B6869>;
#[doc = "Register MASK8B6869 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B6869 {
    type Type = u32;
    #[inline(always)]
