#[doc = "Writer for register MASK8B3031"]
pub type W = crate::W<u32, super::MASK8B3031>;
#[doc = "Register MASK8B3031 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B3031 {
    type Type = u32;
    #[inline(always)]
