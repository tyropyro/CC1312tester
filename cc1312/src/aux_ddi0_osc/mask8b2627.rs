#[doc = "Writer for register MASK8B2627"]
pub type W = crate::W<u32, super::MASK8B2627>;
#[doc = "Register MASK8B2627 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B2627 {
    type Type = u32;
    #[inline(always)]
