#[doc = "Writer for register MASK8B2425"]
pub type W = crate::W<u32, super::MASK8B2425>;
#[doc = "Register MASK8B2425 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B2425 {
    type Type = u32;
    #[inline(always)]
