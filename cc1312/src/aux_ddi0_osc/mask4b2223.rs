#[doc = "Writer for register MASK4B2223"]
pub type W = crate::W<u32, super::MASK4B2223>;
#[doc = "Register MASK4B2223 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B2223 {
    type Type = u32;
    #[inline(always)]
