#[doc = "Writer for register MASK8B3435"]
pub type W = crate::W<u32, super::MASK8B3435>;
#[doc = "Register MASK8B3435 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B3435 {
    type Type = u32;
    #[inline(always)]
