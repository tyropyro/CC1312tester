#[doc = "Writer for register MASK4B5051"]
pub type W = crate::W<u32, super::MASK4B5051>;
#[doc = "Register MASK4B5051 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B5051 {
    type Type = u32;
    #[inline(always)]
