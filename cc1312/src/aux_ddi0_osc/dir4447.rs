#[doc = "Reader of register DIR4447"]
pub type R = crate::R<u32, super::DIR4447>;
#[doc = "Writer for register DIR4447"]
pub type W = crate::W<u32, super::DIR4447>;
#[doc = "Register DIR4447 `reset()`'s with value 0"]
impl crate::ResetValue for super::DIR4447 {
    type Type = u32;
    #[inline(always)]
