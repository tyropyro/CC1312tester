#[doc = "Writer for register MASK4B3435"]
pub type W = crate::W<u32, super::MASK4B3435>;
#[doc = "Register MASK4B3435 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B3435 {
    type Type = u32;
    #[inline(always)]
