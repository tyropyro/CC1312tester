#[doc = "Writer for register MASK4B4041"]
pub type W = crate::W<u32, super::MASK4B4041>;
#[doc = "Register MASK4B4041 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B4041 {
    type Type = u32;
    #[inline(always)]
