#[doc = "Writer for register MASK4B2829"]
pub type W = crate::W<u32, super::MASK4B2829>;
#[doc = "Register MASK4B2829 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B2829 {
    type Type = u32;
    #[inline(always)]
