#[doc = "Writer for register MASK4B6061"]
pub type W = crate::W<u32, super::MASK4B6061>;
#[doc = "Register MASK4B6061 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B6061 {
    type Type = u32;
    #[inline(always)]
