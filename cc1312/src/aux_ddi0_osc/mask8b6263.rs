#[doc = "Writer for register MASK8B6263"]
pub type W = crate::W<u32, super::MASK8B6263>;
#[doc = "Register MASK8B6263 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B6263 {
    type Type = u32;
    #[inline(always)]
