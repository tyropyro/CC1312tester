#[doc = "Writer for register MASK8B3839"]
pub type W = crate::W<u32, super::MASK8B3839>;
#[doc = "Register MASK8B3839 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B3839 {
    type Type = u32;
    #[inline(always)]
