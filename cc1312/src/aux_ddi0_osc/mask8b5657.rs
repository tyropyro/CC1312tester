#[doc = "Writer for register MASK8B5657"]
pub type W = crate::W<u32, super::MASK8B5657>;
#[doc = "Register MASK8B5657 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B5657 {
    type Type = u32;
    #[inline(always)]
