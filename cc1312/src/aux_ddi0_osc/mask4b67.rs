#[doc = "Writer for register MASK4B67"]
pub type W = crate::W<u32, super::MASK4B67>;
#[doc = "Register MASK4B67 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B67 {
    type Type = u32;
    #[inline(always)]
