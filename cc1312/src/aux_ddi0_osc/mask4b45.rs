#[doc = "Writer for register MASK4B45"]
pub type W = crate::W<u32, super::MASK4B45>;
#[doc = "Register MASK4B45 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B45 {
    type Type = u32;
    #[inline(always)]
