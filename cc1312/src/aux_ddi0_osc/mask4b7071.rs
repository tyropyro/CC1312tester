#[doc = "Writer for register MASK4B7071"]
pub type W = crate::W<u32, super::MASK4B7071>;
#[doc = "Register MASK4B7071 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B7071 {
    type Type = u32;
    #[inline(always)]
