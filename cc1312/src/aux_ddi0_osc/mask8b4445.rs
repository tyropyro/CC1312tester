#[doc = "Writer for register MASK8B4445"]
pub type W = crate::W<u32, super::MASK8B4445>;
#[doc = "Register MASK8B4445 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B4445 {
    type Type = u32;
    #[inline(always)]
