#[doc = "Writer for register MASK8B1819"]
pub type W = crate::W<u32, super::MASK8B1819>;
#[doc = "Register MASK8B1819 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B1819 {
    type Type = u32;
    #[inline(always)]
