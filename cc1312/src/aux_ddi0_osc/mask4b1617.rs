#[doc = "Writer for register MASK4B1617"]
pub type W = crate::W<u32, super::MASK4B1617>;
#[doc = "Register MASK4B1617 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B1617 {
    type Type = u32;
    #[inline(always)]
