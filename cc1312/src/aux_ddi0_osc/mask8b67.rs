#[doc = "Writer for register MASK8B67"]
pub type W = crate::W<u32, super::MASK8B67>;
#[doc = "Register MASK8B67 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B67 {
    type Type = u32;
    #[inline(always)]
