...
pub struct RegisterBlock {
    ...
    #[doc = "0x294 - User Identification. eading this register and the FCFG1:ICEPICK_DEVICE_ID register is the only supported way of identifying a device. he value of this register will be written to AON_PMCTL:JTAGUSERCODE by boot FW while in safezone."]
    pub user_id: USER_ID,
    ...
    #[doc = "0x318 - IcePick Device Identification eading this register and the FCFG1:USER_ID register is the only supported way of identifying a device."]
...
#[doc = "Internal. Only to be used through TI provided API."]
pub mod flash_v;
#[doc = "User Identification. eading this register and the FCFG1:ICEPICK_DEVICE_ID register is the only supported way of identifying a device. he value of this register will be written to AON_PMCTL:JTAGUSERCODE by boot FW while in safezone.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [user_id](user_id) module"]
...
#[doc = "IcePick Device Identification eading this register and the FCFG1:USER_ID register is the only supported way of identifying a device.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [icepick_device_id](icepick_device_id) module"]
