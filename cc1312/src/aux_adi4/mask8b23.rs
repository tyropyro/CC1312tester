#[doc = "Writer for register MASK8B23"]
pub type W = crate::W<u32, super::MASK8B23>;
#[doc = "Register MASK8B23 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B23 {
    type Type = u32;
    #[inline(always)]
