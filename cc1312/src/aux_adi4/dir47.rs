#[doc = "Reader of register DIR47"]
pub type R = crate::R<u32, super::DIR47>;
#[doc = "Writer for register DIR47"]
pub type W = crate::W<u32, super::DIR47>;
#[doc = "Register DIR47 `reset()`'s with value 0"]
impl crate::ResetValue for super::DIR47 {
    type Type = u32;
    #[inline(always)]
