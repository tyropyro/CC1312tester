...
pub struct RegisterBlock {
    ...
    #[doc = "0x04 - Status"]
    pub stat: STAT,
    #[doc = "0x08 - Result esult of last TDC conversion."]
    pub result: RESULT,
    #[doc = "0x0c - Saturation Configuration"]
    pub satcfg: SATCFG,
    #[doc = "0x10 - Trigger Source elect source and polarity for TDC start and stop events. See the Technical Reference Manual for event timing requirements."]
    pub trigsrc: TRIGSRC,
    #[doc = "0x14 - Trigger Counter top-counter control and status."]
    pub trigcnt: TRIGCNT,
    #[doc = "0x18 - Trigger Counter Load top-counter load."]
    pub trigcntload: TRIGCNTLOAD,
    #[doc = "0x1c - Trigger Counter Configuration top-counter configuration."]
    pub trigcntcfg: TRIGCNTCFG,
    #[doc = "0x20 - Prescaler Control he prescaler can be used to count events that are faster than the AUX bus rate. t can be used to: count pulses on a specified event from the asynchronous event bus. prescale a specified event from the asynchronous event bus. o use the prescaler output as an event source in TDC measurements you must set both TRIGSRC.START_SRC and TRIGSRC.STOP_SRC to AUX_TDC_PRE. t is recommended to use the prescaler when the signal frequency to measure exceeds 1/10th of the AUX bus rate."]
    pub prectl: PRECTL,
...
#[doc = "Saturation Configuration"]
pub mod satcfg;
#[doc = "Trigger Source elect source and polarity for TDC start and stop events. See the Technical Reference Manual for event timing requirements.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [trigsrc](trigsrc) module"]
