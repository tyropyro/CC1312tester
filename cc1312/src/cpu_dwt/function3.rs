#[doc = "Reader of register FUNCTION3"]
pub type R = crate::R<u32, super::FUNCTION3>;
#[doc = "Writer for register FUNCTION3"]
pub type W = crate::W<u32, super::FUNCTION3>;
#[doc = "Register FUNCTION3 `reset()`'s with value 0"]
impl crate::ResetValue for super::FUNCTION3 {
    type Type = u32;
    #[inline(always)]
