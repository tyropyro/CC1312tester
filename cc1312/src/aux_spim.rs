...
pub struct RegisterBlock {
    #[doc = "0x00 - SPI Master Configuration rite operation stalls until current transfer completes."]
    pub spimcfg: SPIMCFG,
    #[doc = "0x04 - MISO Configuration rite operation stalls until current transfer completes."]
    pub misocfg: MISOCFG,
    #[doc = "0x08 - MOSI Control rite operation stalls until current transfer completes."]
    pub mosictl: MOSICTL,
    #[doc = "0x0c - Transmit 8 Bit rite operation stalls until current transfer completes."]
    pub tx8: TX8,
    #[doc = "0x10 - Transmit 16 Bit rite operation stalls until current transfer completes."]
    pub tx16: TX16,
    #[doc = "0x14 - Receive 8 Bit ead operation stalls until current transfer completes."]
    pub rx8: RX8,
    #[doc = "0x18 - Receive 16 Bit ead operation stalls until current transfer completes."]
    pub rx16: RX16,
    #[doc = "0x1c - SCLK Idle ead operation stalls until SCLK is idle with no remaining clock edges."]
    pub sclkidle: SCLKIDLE,
    #[doc = "0x20 - Data Idle ead operation stalls until current transfer completes."]
    pub dataidle: DATAIDLE,
}
#[doc = "SPI Master Configuration rite operation stalls until current transfer completes.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spimcfg](spimcfg) module"]
...
#[doc = "SPI Master Configuration rite operation stalls until current transfer completes."]
pub mod spimcfg;
#[doc = "MISO Configuration rite operation stalls until current transfer completes.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [misocfg](misocfg) module"]
...
#[doc = "MOSI Control rite operation stalls until current transfer completes."]
pub mod mosictl;
#[doc = "Transmit 8 Bit rite operation stalls until current transfer completes.\n\nThis register you can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tx8](tx8) module"]
...
#[doc = "Transmit 8 Bit rite operation stalls until current transfer completes."]
pub mod tx8;
#[doc = "Transmit 16 Bit rite operation stalls until current transfer completes.\n\nThis register you can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tx16](tx16) module"]
...
#[doc = "Receive 8 Bit ead operation stalls until current transfer completes."]
pub mod rx8;
#[doc = "Receive 16 Bit ead operation stalls until current transfer completes.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rx16](rx16) module"]
...
#[doc = "Receive 16 Bit ead operation stalls until current transfer completes."]
pub mod rx16;
#[doc = "SCLK Idle ead operation stalls until SCLK is idle with no remaining clock edges.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sclkidle](sclkidle) module"]
...
#[doc = "SCLK Idle ead operation stalls until SCLK is idle with no remaining clock edges."]
pub mod sclkidle;
#[doc = "Data Idle ead operation stalls until current transfer completes.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dataidle](dataidle) module"]
