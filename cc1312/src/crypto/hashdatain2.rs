#[doc = "Writer for register HASHDATAIN2"]
pub type W = crate::W<u32, super::HASHDATAIN2>;
#[doc = "Register HASHDATAIN2 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN2 {
    type Type = u32;
    #[inline(always)]
