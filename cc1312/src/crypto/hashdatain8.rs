#[doc = "Writer for register HASHDATAIN8"]
pub type W = crate::W<u32, super::HASHDATAIN8>;
#[doc = "Register HASHDATAIN8 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN8 {
    type Type = u32;
    #[inline(always)]
