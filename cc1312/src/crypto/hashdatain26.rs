#[doc = "Writer for register HASHDATAIN26"]
pub type W = crate::W<u32, super::HASHDATAIN26>;
#[doc = "Register HASHDATAIN26 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN26 {
    type Type = u32;
    #[inline(always)]
