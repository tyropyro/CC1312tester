#[doc = "Writer for register HASHDATAIN27"]
pub type W = crate::W<u32, super::HASHDATAIN27>;
#[doc = "Register HASHDATAIN27 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN27 {
    type Type = u32;
    #[inline(always)]
