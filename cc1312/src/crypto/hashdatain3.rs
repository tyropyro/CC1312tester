#[doc = "Writer for register HASHDATAIN3"]
pub type W = crate::W<u32, super::HASHDATAIN3>;
#[doc = "Register HASHDATAIN3 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN3 {
    type Type = u32;
    #[inline(always)]
