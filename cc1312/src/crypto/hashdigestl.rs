#[doc = "Reader of register HASHDIGESTL"]
pub type R = crate::R<u32, super::HASHDIGESTL>;
#[doc = "Writer for register HASHDIGESTL"]
pub type W = crate::W<u32, super::HASHDIGESTL>;
#[doc = "Register HASHDIGESTL `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTL {
    type Type = u32;
    #[inline(always)]
