#[doc = "Writer for register HASHDATAIN17"]
pub type W = crate::W<u32, super::HASHDATAIN17>;
#[doc = "Register HASHDATAIN17 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN17 {
    type Type = u32;
    #[inline(always)]
