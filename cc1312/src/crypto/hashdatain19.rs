#[doc = "Writer for register HASHDATAIN19"]
pub type W = crate::W<u32, super::HASHDATAIN19>;
#[doc = "Register HASHDATAIN19 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN19 {
    type Type = u32;
    #[inline(always)]
