#[doc = "Reader of register HASHDIGESTG"]
pub type R = crate::R<u32, super::HASHDIGESTG>;
#[doc = "Writer for register HASHDIGESTG"]
pub type W = crate::W<u32, super::HASHDIGESTG>;
#[doc = "Register HASHDIGESTG `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTG {
    type Type = u32;
    #[inline(always)]
