#[doc = "Writer for register HASHDATAIN11"]
pub type W = crate::W<u32, super::HASHDATAIN11>;
#[doc = "Register HASHDATAIN11 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN11 {
    type Type = u32;
    #[inline(always)]
