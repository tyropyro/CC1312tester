#[doc = "Reader of register HASHDIGESTN"]
pub type R = crate::R<u32, super::HASHDIGESTN>;
#[doc = "Writer for register HASHDIGESTN"]
pub type W = crate::W<u32, super::HASHDIGESTN>;
#[doc = "Register HASHDIGESTN `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTN {
    type Type = u32;
    #[inline(always)]
