#[doc = "Writer for register HASHDATAIN31"]
pub type W = crate::W<u32, super::HASHDATAIN31>;
#[doc = "Register HASHDATAIN31 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN31 {
    type Type = u32;
    #[inline(always)]
