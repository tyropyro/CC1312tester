#[doc = "Writer for register HASHDATAIN18"]
pub type W = crate::W<u32, super::HASHDATAIN18>;
#[doc = "Register HASHDATAIN18 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN18 {
    type Type = u32;
    #[inline(always)]
