#[doc = "Reader of register HASHDIGESTF"]
pub type R = crate::R<u32, super::HASHDIGESTF>;
#[doc = "Writer for register HASHDIGESTF"]
pub type W = crate::W<u32, super::HASHDIGESTF>;
#[doc = "Register HASHDIGESTF `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTF {
    type Type = u32;
    #[inline(always)]
