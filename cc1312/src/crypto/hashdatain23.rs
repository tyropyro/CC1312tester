#[doc = "Writer for register HASHDATAIN23"]
pub type W = crate::W<u32, super::HASHDATAIN23>;
#[doc = "Register HASHDATAIN23 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN23 {
    type Type = u32;
    #[inline(always)]
