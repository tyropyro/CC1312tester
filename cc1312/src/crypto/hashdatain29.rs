#[doc = "Writer for register HASHDATAIN29"]
pub type W = crate::W<u32, super::HASHDATAIN29>;
#[doc = "Register HASHDATAIN29 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN29 {
    type Type = u32;
    #[inline(always)]
