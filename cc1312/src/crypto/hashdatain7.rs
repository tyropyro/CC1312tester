#[doc = "Writer for register HASHDATAIN7"]
pub type W = crate::W<u32, super::HASHDATAIN7>;
#[doc = "Register HASHDATAIN7 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN7 {
    type Type = u32;
    #[inline(always)]
