#[doc = "Writer for register HASHDATAIN10"]
pub type W = crate::W<u32, super::HASHDATAIN10>;
#[doc = "Register HASHDATAIN10 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN10 {
    type Type = u32;
    #[inline(always)]
