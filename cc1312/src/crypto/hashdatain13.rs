#[doc = "Writer for register HASHDATAIN13"]
pub type W = crate::W<u32, super::HASHDATAIN13>;
#[doc = "Register HASHDATAIN13 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN13 {
    type Type = u32;
    #[inline(always)]
