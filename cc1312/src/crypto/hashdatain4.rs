#[doc = "Writer for register HASHDATAIN4"]
pub type W = crate::W<u32, super::HASHDATAIN4>;
#[doc = "Register HASHDATAIN4 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN4 {
    type Type = u32;
    #[inline(always)]
