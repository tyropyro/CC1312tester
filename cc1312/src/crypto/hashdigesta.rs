#[doc = "Reader of register HASHDIGESTA"]
pub type R = crate::R<u32, super::HASHDIGESTA>;
#[doc = "Writer for register HASHDIGESTA"]
pub type W = crate::W<u32, super::HASHDIGESTA>;
#[doc = "Register HASHDIGESTA `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTA {
    type Type = u32;
    #[inline(always)]
