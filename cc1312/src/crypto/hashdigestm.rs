#[doc = "Reader of register HASHDIGESTM"]
pub type R = crate::R<u32, super::HASHDIGESTM>;
#[doc = "Writer for register HASHDIGESTM"]
pub type W = crate::W<u32, super::HASHDIGESTM>;
#[doc = "Register HASHDIGESTM `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTM {
    type Type = u32;
    #[inline(always)]
