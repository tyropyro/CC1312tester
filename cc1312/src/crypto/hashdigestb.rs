#[doc = "Reader of register HASHDIGESTB"]
pub type R = crate::R<u32, super::HASHDIGESTB>;
#[doc = "Writer for register HASHDIGESTB"]
pub type W = crate::W<u32, super::HASHDIGESTB>;
#[doc = "Register HASHDIGESTB `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTB {
    type Type = u32;
    #[inline(always)]
