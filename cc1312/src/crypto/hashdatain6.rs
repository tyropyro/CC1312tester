#[doc = "Writer for register HASHDATAIN6"]
pub type W = crate::W<u32, super::HASHDATAIN6>;
#[doc = "Register HASHDATAIN6 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN6 {
    type Type = u32;
    #[inline(always)]
