#[doc = "Writer for register HASHDATAIN24"]
pub type W = crate::W<u32, super::HASHDATAIN24>;
#[doc = "Register HASHDATAIN24 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN24 {
    type Type = u32;
    #[inline(always)]
