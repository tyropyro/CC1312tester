#[doc = "Writer for register HASHDATAIN5"]
pub type W = crate::W<u32, super::HASHDATAIN5>;
#[doc = "Register HASHDATAIN5 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN5 {
    type Type = u32;
    #[inline(always)]
