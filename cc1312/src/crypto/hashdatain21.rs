#[doc = "Writer for register HASHDATAIN21"]
pub type W = crate::W<u32, super::HASHDATAIN21>;
#[doc = "Register HASHDATAIN21 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN21 {
    type Type = u32;
    #[inline(always)]
