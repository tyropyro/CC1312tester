#[doc = "Writer for register HASHDATAIN14"]
pub type W = crate::W<u32, super::HASHDATAIN14>;
#[doc = "Register HASHDATAIN14 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN14 {
    type Type = u32;
    #[inline(always)]
