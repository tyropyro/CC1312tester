#[doc = "Writer for register HASHDATAIN20"]
pub type W = crate::W<u32, super::HASHDATAIN20>;
#[doc = "Register HASHDATAIN20 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN20 {
    type Type = u32;
    #[inline(always)]
