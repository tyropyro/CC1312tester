#[doc = "Reader of register HASHDIGESTD"]
pub type R = crate::R<u32, super::HASHDIGESTD>;
#[doc = "Writer for register HASHDIGESTD"]
pub type W = crate::W<u32, super::HASHDIGESTD>;
#[doc = "Register HASHDIGESTD `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTD {
    type Type = u32;
    #[inline(always)]
