#[doc = "Writer for register HASHDATAIN28"]
pub type W = crate::W<u32, super::HASHDATAIN28>;
#[doc = "Register HASHDATAIN28 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN28 {
    type Type = u32;
    #[inline(always)]
