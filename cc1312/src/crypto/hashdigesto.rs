#[doc = "Reader of register HASHDIGESTO"]
pub type R = crate::R<u32, super::HASHDIGESTO>;
#[doc = "Writer for register HASHDIGESTO"]
pub type W = crate::W<u32, super::HASHDIGESTO>;
#[doc = "Register HASHDIGESTO `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTO {
    type Type = u32;
    #[inline(always)]
