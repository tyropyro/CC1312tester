#[doc = "Writer for register HASHDATAIN12"]
pub type W = crate::W<u32, super::HASHDATAIN12>;
#[doc = "Register HASHDATAIN12 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN12 {
    type Type = u32;
    #[inline(always)]
