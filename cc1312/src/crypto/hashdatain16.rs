#[doc = "Writer for register HASHDATAIN16"]
pub type W = crate::W<u32, super::HASHDATAIN16>;
#[doc = "Register HASHDATAIN16 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN16 {
    type Type = u32;
    #[inline(always)]
