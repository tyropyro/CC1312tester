#[doc = "Writer for register HASHDATAIN9"]
pub type W = crate::W<u32, super::HASHDATAIN9>;
#[doc = "Register HASHDATAIN9 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN9 {
    type Type = u32;
    #[inline(always)]
