#[doc = "Writer for register HASHDATAIN15"]
pub type W = crate::W<u32, super::HASHDATAIN15>;
#[doc = "Register HASHDATAIN15 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN15 {
    type Type = u32;
    #[inline(always)]
