#[doc = "Reader of register HASHDIGESTI"]
pub type R = crate::R<u32, super::HASHDIGESTI>;
#[doc = "Writer for register HASHDIGESTI"]
pub type W = crate::W<u32, super::HASHDIGESTI>;
#[doc = "Register HASHDIGESTI `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTI {
    type Type = u32;
    #[inline(always)]
