#[doc = "Reader of register HASHDIGESTH"]
pub type R = crate::R<u32, super::HASHDIGESTH>;
#[doc = "Writer for register HASHDIGESTH"]
pub type W = crate::W<u32, super::HASHDIGESTH>;
#[doc = "Register HASHDIGESTH `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTH {
    type Type = u32;
    #[inline(always)]
