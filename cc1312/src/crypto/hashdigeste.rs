#[doc = "Reader of register HASHDIGESTE"]
pub type R = crate::R<u32, super::HASHDIGESTE>;
#[doc = "Writer for register HASHDIGESTE"]
pub type W = crate::W<u32, super::HASHDIGESTE>;
#[doc = "Register HASHDIGESTE `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTE {
    type Type = u32;
    #[inline(always)]
