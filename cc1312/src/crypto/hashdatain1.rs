#[doc = "Writer for register HASHDATAIN1"]
pub type W = crate::W<u32, super::HASHDATAIN1>;
#[doc = "Register HASHDATAIN1 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN1 {
    type Type = u32;
    #[inline(always)]
