#[doc = "Reader of register HASHDIGESTP"]
pub type R = crate::R<u32, super::HASHDIGESTP>;
#[doc = "Writer for register HASHDIGESTP"]
pub type W = crate::W<u32, super::HASHDIGESTP>;
#[doc = "Register HASHDIGESTP `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDIGESTP {
    type Type = u32;
    #[inline(always)]
