#[doc = "Writer for register HASHDATAIN30"]
pub type W = crate::W<u32, super::HASHDATAIN30>;
#[doc = "Register HASHDATAIN30 `reset()`'s with value 0"]
impl crate::ResetValue for super::HASHDATAIN30 {
    type Type = u32;
    #[inline(always)]
