#[doc = "Writer for register MASK4B01"]
pub type W = crate::W<u32, super::MASK4B01>;
#[doc = "Register MASK4B01 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B01 {
    type Type = u32;
    #[inline(always)]
