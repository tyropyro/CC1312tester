#[doc = "Writer for register MASK4B1415"]
pub type W = crate::W<u32, super::MASK4B1415>;
#[doc = "Register MASK4B1415 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK4B1415 {
    type Type = u32;
    #[inline(always)]
