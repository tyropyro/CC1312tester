#[doc = "Writer for register MASK8B01"]
pub type W = crate::W<u32, super::MASK8B01>;
#[doc = "Register MASK8B01 `reset()`'s with value 0"]
impl crate::ResetValue for super::MASK8B01 {
    type Type = u32;
    #[inline(always)]
