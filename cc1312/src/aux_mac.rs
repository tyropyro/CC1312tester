...
pub struct RegisterBlock {
    ...
    pub cls: CLS,
    #[doc = "0x30 - Accumulator Shift nly one shift operation can be triggered per register write."]
...
#[doc = "Count Leading Sign"]
pub mod cls;
#[doc = "Accumulator Shift nly one shift operation can be triggered per register write.\n\nThis register you can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [accshift](accshift) module"]
